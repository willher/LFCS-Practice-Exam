...
docker container create --name docker2 -p 80:8081 --restart unless-stopped nginx
...
I don't know yo if y'all peeps be buggin' give props to my doe cause we all fly,
But I can take the heat cause I'm the other one known as 'Kid Funky Fried',
Yeah I'm kinda like planet Pluto hard to see with the naked eye,
But if I dashed into another I would where the sun don't shine,
Cause I'm kind of like Han Solo always hanging with my wookie, Chewey,
...
So if man is five and women  is six than that must make me seven,
